    ...
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="font-display text-2xl font-bold">
          Bonjour, Prof. {profile?.last_name} 👋
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="shadow-card border-0">
          <CardHeader><CardTitle className="font-display text-lg">Cours d'aujourd'hui</CardTitle></CardHeader>
          <CardContent>
        ...
        <Card className="shadow-card border-0">
          <CardHeader><CardTitle className="font-display text-lg">Soumissions récentes</CardTitle></CardHeader>
          <CardContent>
            <div className="space-y-3">
              {[
                { student: "Ahmed B.", text: "Compte rendu TP3 - Algorithmique", time: "Il y a 1h" },
                { student: "Sara M.", text: "Compte rendu TP2 - Base de données", time: "Il y a 3h" },
                { student: "Karim L.", text: "Réponse forum - SQL avancé", time: "Hier" },
              ].map((item, i) => (
