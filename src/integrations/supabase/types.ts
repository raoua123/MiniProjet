  ...
  public: {
    Tables: {
      ...
      courses: {
        ...
        Relationships: [
          {
            foreignKeyName: "courses_filiere_id_fkey"
            columns: ["filiere_id"]
            isOneToOne: false
      ...
      groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "groups_filiere_id_fkey"
            columns: ["filiere_id"]
            isOneToOne: false
            referencedRelation: "filieres"
            referencedColumns: ["id"]
      ...
      student_details: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_details_filiere_id_fkey"
            columns: ["filiere_id"]
            isOneToOne: false
            referencedRelation: "filieres"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_details_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
